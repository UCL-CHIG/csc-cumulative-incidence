...
cin <- cin[cinreferraldate_clean > as.Date("2011-03-31")]
...
# 2012/2013
ref_birth_2013 <- cin[birthfyear == 2013] # get referrals for children born in 2011/2012
...
ax_birth_2013 <- cin[birthfyear == 2013 & referralnfa == 0]
...
cin_birth_2013 <- cin[birthfyear == 2013 & referralnfa == 0 & (reasonforclosure != "RC8" | is.na(reasonforclosure))]
...
cpp_birth_2013 <- cin[birthfyear == 2013 & !is.na(cppstartdate)]
...
write.csv(output, file = "outputs/cin/sa2/birth_2013_sa2.csv")
rm(output)

# 2005/2006
ref_birth_2006 <- cin[birthfyear == 2006]
...
ax_birth_2006 <- cin[birthfyear == 2006 & referralnfa == 0]
...
cin_birth_2006 <- cin[birthfyear == 2006 & referralnfa == 0 & (reasonforclosure != "RC8" | is.na(reasonforclosure))]
...
cpp_birth_2006 <- cin[birthfyear == 2006 & !is.na(cppstartdate)]
...
output <- cbind(table(ref_birth_2006$age_yrs_int),
                ...
                table(cpp_birth_2006$age_yrs_int))
colnames(output) <- c("referrals", "assessed", "need", "cpp")
write.csv(output, file = "outputs/cin/sa2/birth_2006_sa2.csv")
rm(output)

# 2000/2001
ref_birth_2001 <- cin[birthfyear == 2001]
...
ax_birth_2001 <- cin[birthfyear == 2001 & referralnfa == 0]
...
cin_birth_2001 <- cin[birthfyear == 2001 & referralnfa == 0 & (reasonforclosure != "RC8" | is.na(reasonforclosure))]
...
cpp_birth_2001 <- cin[birthfyear == 2001 & !is.na(cppstartdate)]
...
output <- cbind(table(ref_birth_2001$age_yrs_int),
                ...
                table(cpp_birth_2001$age_yrs_int))
colnames(output) <- c("referrals", "assessed", "need", "cpp")
write.csv(output, file = "outputs/cin/sa2/birth_2001_sa2.csv")
...
ref_tmp <- cin[birthfyear == 2013 & age_yrs_int < 6]
...
for (i in 1:nrow(output)) {
  ...
  n <- table(recurrence[, i + 2, with = F])[2]
  p <- round(prop.table(table(recurrence[, i + 2, with = F]))[2] * 100, 2)
...
ax_tmp <- cin[birthfyear == 2013 & age_yrs_int < 6 & referralnfa == 0]
...
cin_tmp <- cin[birthfyear == 2013 & age_yrs_int < 6 & referralnfa == 0 & (reasonforclosure != "RC8" | is.na(reasonforclosure))]
...
cpp_tmp <- cin[birthfyear == 2013 & age_yrs_int < 6 & !is.na(cppstartdate)]
...
write.csv(output, "outputs/cin/sa2/recurrence_sa2_raw.csv")
